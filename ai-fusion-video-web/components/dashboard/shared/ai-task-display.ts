export const toolDisplayNames: Record<string, string> = {
  ...
  generate_video: "AI 生成视频（历史）",
  update_storyboard_item_video: "更新分镜视频提示词",
  update_storyboard_item_frame: "更新分镜首尾帧",
  update_storyboard_item_workflow: "更新分镜视频工作流",
  update_storyboard_item_assets: "更新分镜资产",
  ...
  match_storyboard_item_assets: "匹配镜头资产（子Agent）",
  generate_asset_image: "生成资产图片（子Agent）",
  generate_storyboard_frame: "生成分镜首尾帧（子Agent）",
  generate_storyboard_video: "生成分镜视频提示词（子Agent）",
};
...
export const agentTypeNames: Record<string, string> = {
  ...
  storyboard_asset_matcher: "AI匹配分镜资产",
  storyboard_asset_match_executor: "分镜资产匹配执行",
  ...
  storyboard_narrative_expand: "剧情素材包生成",
  storyboard_action_expand: "战斗素材包生成",
  storyboard_video_prompt_gen: "视频提示词生成",
  storyboard_video_gen: "分镜视频提示词生成",
  storyboard_video_executor: "分镜视频提示词执行",
