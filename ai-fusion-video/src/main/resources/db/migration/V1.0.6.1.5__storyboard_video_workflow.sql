ALTER TABLE `afv_storyboard_item`
    ...
    ADD COLUMN `grid25_reference_image_urls` json DEFAULT NULL COMMENT '25宫格生成参考图URL数组' AFTER `grid25_prompt`,
    ADD COLUMN `action_storyboard_image_url` varchar(1024) DEFAULT NULL COMMENT '动作故事板图URL' AFTER `grid25_reference_image_urls`,
